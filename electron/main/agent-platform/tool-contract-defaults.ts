...
import type { AgentToolDefinition, AgentToolLanguageFamily, AgentToolProtocolResult, AgentToolResultMappingContext } from './tool-registry-core';
...
const toolContractSpecs = {
  ...
  media_save_base64: { label: 'Save media', activity: 'Saving media', family: 'media', usageHint: 'Persist generated or captured media as a project attachment.', target: targetFrom('fileName', 'title'), isConcurrencySafe: neverSafe },
  image_generate: { label: 'Generate image', activity: 'Generating image', aliases: ['ImageGenerate'], family: 'media', canonicalName: 'ImageGenerate', usageHint: 'Generate bitmap art or assets when the user asks for visual creation.', target: targetFrom('prompt'), isConcurrencySafe: neverSafe },
  ...
  generate_asset: { label: 'Generate asset', activity: 'Generating asset', aliases: ['AssetGenerate'], family: 'media', usageHint: 'Generate project assets through the unified Asset Generation Center instead of ad hoc file writes.', target: targetFrom('title', 'kind'), classifier: (input) => ({ toolClass: 'asset_generation', kind: asString(input, 'kind'), title: asString(input, 'title'), prompt: previewText(asString(input, 'prompt')) }), isConcurrencySafe: neverSafe },
  import_generated_asset: { label: 'Import generated asset', activity: 'Importing generated asset', aliases: ['AssetImport'], family: 'media', usageHint: 'Mark a generated asset job as imported after verifying or using its outputs.', target: targetFrom('jobId'), isConcurrencySafe: neverSafe },
  ...
  refresh_engine_runtime_state: { label: 'Refresh engine state', activity: 'Refreshing engine state', family: 'engine', usageHint: 'Refresh known runtime state after opening Unity or engine MCP.', target: targetFrom('platform', 'projectPath'), isConcurrencySafe: alwaysSafe },
  open_engine_hub: { label: 'Open engine hub', activity: 'Opening engine hub', family: 'engine', usageHint: 'Open the installed engine hub application.', target: targetFrom('platform'), isConcurrencySafe: neverSafe },
  open_engine_project: { label: 'Open engine project', activity: 'Opening engine project', family: 'engine', usageHint: 'Open the project with the matching engine version when available.', target: targetFrom('projectPath', 'platform'), isConcurrencySafe: neverSafe },
  install_engine_bridge: { label: 'Install engine bridge', activity: 'Installing engine bridge', family: 'engine', usageHint: 'Install the project bridge required for engine MCP/tooling.', target: targetFrom('projectPath', 'platform'), isConcurrencySafe: neverSafe },
  ...
  create_directory: { label: 'Create directory', activity: 'Creating directory', aliases: ['Mkdir'], family: 'edit', canonicalName: 'Mkdir', usageHint: 'Create only the directory needed for the user task.', protocolKind: 'edit', target: targetFrom('path'), classifier: (input) => editClassifier('create_directory', input), isConcurrencySafe: neverSafe },
  write_file: { label: 'Write file', activity: 'Writing file', aliases: ['Write'], family: 'edit', canonicalName: 'Write', usageHint: 'Create or fully replace a file when old contents are irrelevant or already known.', protocolKind: 'edit', target: targetFrom('path'), classifier: (input) => editClassifier('write_file', input), isConcurrencySafe: neverSafe },
  edit_file: { label: 'Edit file', activity: 'Editing file', aliases: ['Edit'], family: 'edit', canonicalName: 'Edit', usageHint: 'Replace a unique exact oldText read from the file; prefer MultiEdit for multiple replacements.', failureHint: 'If oldText is not unique or stale, read the file again or switch to patch_file.', protocolKind: 'edit', target: targetFrom('path'), classifier: (input) => editClassifier('edit_file', input), isConcurrencySafe: neverSafe },
  multi_edit: { label: 'Multi edit', activity: 'Editing file', aliases: ['MultiEdit'], family: 'edit', canonicalName: 'MultiEdit', usageHint: 'Apply several ordered exact replacements to the same file.', failureHint: 'Do not call with an empty edits array; re-read the file if any replacement fails.', protocolKind: 'edit', target: targetFrom('path'), classifier: (input) => editClassifier('multi_edit', input), isConcurrencySafe: neverSafe },
  ...
  patch_file: { label: 'Patch file', activity: 'Patching file', aliases: ['ApplyPatch', 'Patch'], family: 'edit', canonicalName: 'ApplyPatch', usageHint: 'Apply a unified diff for structural or multi-file edits.', failureHint: 'If the patch does not apply, read the affected files and regenerate a tighter diff.', protocolKind: 'edit', target: targetFrom('path'), classifier: (input) => editClassifier('patch_file', input), isConcurrencySafe: neverSafe },
  run_command: { label: 'Run command', activity: 'Running command', aliases: ['Bash', 'Shell'], family: 'command', canonicalName: 'Bash', usageHint: 'Run a finite shell command for inspection, build, test, or diagnostics; use terminal_start for long-running servers.', failureHint: 'If a command times out or is interactive, restart it through terminal_start.', protocolKind: 'command', target: targetCommand, classifier: commandClassifier, isConcurrencySafe: safeCommandOnly },
  terminal_start: { label: 'Start terminal', activity: 'Starting terminal', aliases: ['TerminalStart'], family: 'terminal', usageHint: 'Start a long-running dev server or interactive process.', protocolKind: 'terminal', target: targetCommand, classifier: terminalClassifier, isConcurrencySafe: neverSafe },
  ...
  terminal_write: { label: 'Write terminal', activity: 'Writing terminal', aliases: ['TerminalWrite'], family: 'terminal', usageHint: 'Send input to an existing terminal session.', protocolKind: 'terminal', target: targetFrom('sessionId'), classifier: terminalClassifier, isConcurrencySafe: neverSafe },
  ...
  terminal_stop: { label: 'Stop terminal', activity: 'Stopping terminal', aliases: ['TerminalStop'], family: 'terminal', usageHint: 'Stop a long-running session when it is no longer needed.', protocolKind: 'terminal', target: targetFrom('sessionId'), classifier: terminalClassifier, isConcurrencySafe: neverSafe },
  browser_open: { label: 'Open browser', activity: 'Opening browser', family: 'browser', usageHint: 'Open a browser session for local UI verification.', target: targetBrowser, isConcurrencySafe: neverSafe },
  browser_navigate: { label: 'Navigate browser', activity: 'Navigating browser', family: 'browser', usageHint: 'Navigate an existing browser session to a URL.', target: targetBrowser, isConcurrencySafe: neverSafe },
  ...
  browser_click: { label: 'Click browser', activity: 'Clicking browser', family: 'browser', usageHint: 'Click a known selector or coordinate in a browser session.', target: targetBrowser, isConcurrencySafe: neverSafe },
  browser_type: { label: 'Type in browser', activity: 'Typing in browser', family: 'browser', usageHint: 'Type into a focused or selected browser input.', target: targetBrowser, isConcurrencySafe: neverSafe },
  ...
  browser_close: { label: 'Close browser', activity: 'Closing browser', family: 'browser', usageHint: 'Close an unneeded browser session.', target: targetBrowser, isConcurrencySafe: neverSafe },
  ...
  checkpoint_rollback: { label: 'Checkpoint rollback', activity: 'Rolling back checkpoint', aliases: ['CheckpointRollback'], family: 'checkpoint', usageHint: 'Rollback only when explicitly needed or after a failed risky edit path.', protocolKind: 'edit', isConcurrencySafe: neverSafe },
  ...
  call_mcp_tool: { label: 'Call MCP tool', activity: 'Calling MCP tool', aliases: ['CallMcpTool'], family: 'mcp', usageHint: 'Fallback MCP call entry when a direct dynamic mcp__server__tool is absent.', failureHint: 'If the tool is unknown, list MCP tools and retry with the exact name/schema.', protocolKind: 'mcp', target: targetMcp, classifier: mcpClassifier, isConcurrencySafe: safeMcpIfReadOnly },
  ...
  funplay_memory_remember: { label: 'Remember', activity: 'Writing memory', family: 'memory', usageHint: 'Persist stable user preferences, project facts, decisions, or task state only.', target: targetFrom('note'), isConcurrencySafe: neverSafe },
  funplay_notify: { label: 'Notify', activity: 'Sending notification', family: 'notification', usageHint: 'Notify the user only when explicitly requested or when an automation fires.', target: targetFrom('title'), isConcurrencySafe: neverSafe },
  funplay_schedule_task: { label: 'Schedule task', activity: 'Scheduling task', aliases: ['ScheduleTask'], family: 'notification', usageHint: 'Create a future reminder or automation when the user asks for one.', target: targetFrom('name'), isConcurrencySafe: neverSafe },
  ...
  funplay_cancel_task: { label: 'Cancel task', activity: 'Cancelling task', family: 'notification', usageHint: 'Cancel a scheduled task by id.', target: targetFrom('taskId'), isConcurrencySafe: neverSafe },
